                                ...
                                <div class="single-product-content">
                                    ...
                                    <ul class="quantity-with-btn pb-7">
                                        ...
                                        <li class="add-to-cart">
                                            ...
                                            <input style="height: 50px;font-weight: bold" type="button" value="Thêm giỏ hàng" class="btn btn-primary btn-sm add-to-cart" data-id_product="{{$value->product_id}}" name="add-to-cart">
