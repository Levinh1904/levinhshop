...
class BlogController extends Controller
{
    ...
    public function show_blog(){
        ...
        return view('pages.Blog.show_blog')->with('all_blog',$all_blog)->with('category',$cate_product)->with('brand_image',$brand_image)->with('brand',$brand_product)->with('slider',$slider);
    }
